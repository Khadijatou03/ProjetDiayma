...
namespace P2FixAnAppDotNetCode.Models
{
    ...
    public class Cart : ICart
    {
        ...
        public double GetTotalValue()
        {
            // TODO implement the method
            // DONE OD
            // BUG FIX: Multiplier le prix par la quantité pour obtenir le total correct
        ...
        public Product FindProductInCartLines(int productId)
        {
            // TODO implement the method
            // DONE OD
            // BUG FIX: Vérifier si le résultat est null avant d'accéder à la propriété Product
